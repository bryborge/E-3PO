...
#define STRING_CONFIG_H_AUTHOR "(bryborge, Ender-3 Pro v4.2.7 w/ CR Touch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E-3PO (v4.2.7)"
 ...
 *     O-- FRONT --+
 */
// Stock Ender 3 Pro bracket
//   Source: https://printermods.co.uk/blogs/guides/creality-bl-touch-metal-bracket-probe-offset-values
...
#define LCD_BED_TRAMMING // Previously called LEVEL_BED_CORNERS
